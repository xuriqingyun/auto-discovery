...
public class RestConst {
    ...
    public enum SnmpEnum implements RestEnum{
        CANTGETMANUFACTUREROID(1000,"CANTGETMANUFACTUREROID");
        //编码
        private int code;
        ...
        SnmpEnum(int code,String message){
            this.code = code;
            this.message = message;
        }
        @Override
